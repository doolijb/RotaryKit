...
const meta: Meta<typeof ImageView> = {
  ...
  docs: {
    description: {
      component: 'The Image component is used to display images with support for different sizes and formats. It can handle WebP and JPG formats and provides options for small, medium, large, and original sizes.',
    },
  },
}
