...
const countries: Map<string, Country> = new Map<string, Country>()

const countriesData: { [key: string]: Partial<Country> } = {
...
function getRegions(country: string): Map<string, Region> {
    const regions: Map<string, Region> = new Map<string, Region>()
